...
@default true`,defaultValue:{value:"true",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""}}};const S={title:"Components/general/Divider",component:a,tags:["autodocs"],argTypes:{color:{control:{type:"color"},description:"The color of the divider"},orientation:{control:{type:"select",options:["horizontal","vertical"]},description:"The orientation of the divider"}}},r=e=>t.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"48px"},children:t.jsx(a,{...e})});r.__docgenInfo={description:"",methods:[],displayName:"Default"};var p,c,m;r.parameters={...r.parameters,docs:{...(p=r.parameters)==null?void 0:p.docs,source:{originalSource:`(arg: Meta<typeof Divider>) => <div style={{
  display: "flex",
  alignItems: "center",
  ...
  height: "48px"
    ...
    <Divider {...arg} />
  </div>`,...(m=(c=r.parameters)==null?void 0:c.docs)==null?void 0:m.source}}};const C=["Default"];export{r as Default,C as __namedExportsOrder,S as default};
