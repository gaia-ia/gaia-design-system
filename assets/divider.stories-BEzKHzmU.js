...
@default true`,defaultValue:{value:"true",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""}}};const q={title:"Components/general/Divider",component:a,tags:["autodocs"],argTypes:{color:{control:{type:"color"},description:"The color of the divider"},orientation:{control:{type:"select",options:["horizontal","vertical"]},description:"The orientation of the divider"}}},t=e=>o.jsx("div",{style:{display:"flex",alignItems:"center",justifyContent:"center",height:"48px"},children:o.jsx(a,{...e})});t.__docgenInfo={description:"",methods:[],displayName:"Default"};var p,c,m;t.parameters={...t.parameters,docs:{...(p=t.parameters)==null?void 0:p.docs,source:{originalSource:`(arg: Meta<typeof Divider>) => <div style={{
  display: "flex",
  alignItems: "center",
  ...
  height: "48px"
    ...
    <Divider {...arg} />
  </div>`,...(m=(c=t.parameters)==null?void 0:c.docs)==null?void 0:m.source}}};const A=["Default"];export{t as Default,A as __namedExportsOrder,q as default};
